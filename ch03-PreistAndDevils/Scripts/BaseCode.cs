...
namespace Com.Mygame {
	...
	public class MyCharacterController {
		...
		public MyCharacterController(string which_character) {
			...
			if (which_character == "priest") {
				character = Object.Instantiate (Resources.Load ("Perfabs/Priest", typeof(GameObject))) as GameObject;
				characterType = 0;
			} else {
				character = Object.Instantiate (Resources.Load ("Perfabs/Devil", typeof(GameObject))) as GameObject;
				characterType = 1;
			}
	...
	public class CoastController {
		...
		readonly Vector3 from_pos = new Vector3(10,1,0);
		readonly Vector3 to_pos = new Vector3(-10,1,0);
		...
		public CoastController(string _to_or_from) {
			positions = new Vector3[] {new Vector3(7.5F,2.3F,0), new Vector3(8.5F,2.3F,0), new Vector3(9.5F,2.3F,0), 
				new Vector3(10.5F,2.3F,0), new Vector3(11.5F,2.3F,0), new Vector3(12.5F,2.3F,0)};

			passengerPlaner = new MyCharacterController[6];

			if (_to_or_from == "from") {
				coast = Object.Instantiate (Resources.Load ("Perfabs/Stone", typeof(GameObject)), from_pos, default, null) as GameObject;
				coast.name = "from";
				to_or_from = 1;
			} else {
				coast = Object.Instantiate (Resources.Load ("Perfabs/Stone", typeof(GameObject)), to_pos, default, null) as GameObject;
				coast.name = "to";
				to_or_from = -1;
			}
		}
	...
	public class BoatController {
		...
		readonly Moveable moveableScript;
		readonly Vector3 fromPosition = new Vector3 (5, 0.5F, 0);
		readonly Vector3 toPosition = new Vector3 (-5, 0.5F, 0);
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (4.5F, 1, 0), new Vector3 (5.5F, 1, 0) };
			to_positions = new Vector3[] { new Vector3 (-5.5F, 1, 0), new Vector3 (-4.5F, 1, 0) };

			boat = Object.Instantiate (Resources.Load ("Perfabs/Boat", typeof(GameObject)), fromPosition, new Quaternion(-.7F,.7F,.7F,.7F), null) as GameObject;
			boat.name = "boat";
